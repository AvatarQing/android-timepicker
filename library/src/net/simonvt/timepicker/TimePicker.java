...
public class TimePicker extends FrameLayout {
	...
	private final TextView mDivider1;
	...
	public TimePicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mDivider1 = (TextView) findViewById(R.id.divider1);
		if (mDivider1 != null) {
			mDivider1.setText(R.string.time_picker_separator);
		}
		...
		mSecondSpinnerInput = (EditText) mMinuteSpinner
				.findViewById(R.id.np__numberpicker_input);
	...
	public void setSecondRange(int from, int to) {
		// TODO ÉèÖÃÃëÖÓ·¶Î§
		if (from > to || from < 0 || from > 59 || to < 0 || to > 59) {
			return;
		} else {
			mSecondSpinner.setMinValue(from);
			mSecondSpinner.setMaxValue(to);
		}
	}
}
